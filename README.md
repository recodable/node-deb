...
This is a package that is used in combination with zeit/pkg to package
the executable generated by zeit/pkg. There is no more copy of the node_modules
and the default service template is changed. There is no longer a dependency on node
since the version wanted is in the executable generated by zeit/pkg.


## Installation
`npm install @recodable/node-deb`
